...
((defineFunc) => {
	let define = (deps, func) => defineFunc("/test.js", deps, func);
	__shadeup_gen_shader("shd_3905080038980745077440360007200098768400357301", {
					webgl: {},
...
_i_out.color = vec4<f32>(f32(0.5), _i_in.uv, f32(i32(1)));
...
void main() {
/*__SHADEUP_TEMPLATE_INSERT_MAIN_START__*/
_i_out.color = vec4(float(0.5), _i_in.uv, int(1));

/*__SHADEUP_TEMPLATE_INSERT_MAIN_END__*/
}
`, software: () => {}}, [[2830,2865,21,38],[2939,2972,38,53],[3048,3082,53,69],[3162,3198,69,87],[3242,3284,87,108],[3289,3331,108,129],[3400,3426,129,140],[3502,3532,140,155],[3609,3644,155,169],[3690,3720,169,186],[3768,3800,186,205],[3879,3910,205,223],[3956,3986,223,240],[4051,4074,240,261],[4123,4144,261,280],[2728,4283,0,284],[4371,4409,306,323],[4444,4477,323,338],[4513,4547,338,354],[4585,4621,354,372],[4655,4681,372,383],[4714,4749,383,397],[4309,4869,284,401],[0,0,503,509],[0,0,510,515],[0,0,503,515],[1998,2006,523,528],[0,0,529,532],[0,0,523,533],[0,0,535,540],[0,0,541,543],[0,0,535,543],[2022,2028,545,548],[0,0,549,550],[0,0,545,551],[0,0,518,552],[0,0,503,552],[0,0,503,554],[19,63,401,598],[1952,2035,0,598]]);
...
define(["require", "exports", "/std_math", "/std___std_all", "/_std/drawIndexed"], function (require, exports, __, std___std_all_1, drawIndexed_1) {
    ...
    function main() {
        var _this = this;
        (0, drawIndexed_1.draw)(__shadeup_make_shader_inst("shd_3905080038980745077440360007200098768400357301", {}, /**@shadeup=shader*/ function (__in, __out) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                __out.color = __.makeVector(0.5, __in.uv, (1 | 0));
                return [2 /*return*/];
            });
        }); }));
    }
